...
//    private final TessAPI.TessResultIterator iterator;
     ...
     */
    public final String getText(TesseractLevel level) {
        return this.iterator.getUTF8Text(level.getTessCode()); 
    }
     ...
     */
    public final float getConfidence(TesseractLevel level) {
        return this.iterator.getConfidence(level.getTessCode());
    }
